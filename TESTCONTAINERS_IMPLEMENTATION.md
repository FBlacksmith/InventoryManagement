...
**Updated `tests\InventoryManagement.FunctionalTests\InventoryManagement.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\InventoryManagement.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\InventoryManagement.FunctionalTests\InventoryManagement.FunctionalTests.csproj
```
