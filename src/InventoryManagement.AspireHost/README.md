...
1. Set `InventoryManagement.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../InventoryManagement.Infrastructure/InventoryManagement.Infrastructure.csproj -s InventoryManagement.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../InventoryManagement.Infrastructure/InventoryManagement.Infrastructure.csproj -s InventoryManagement.Web.csproj
```
